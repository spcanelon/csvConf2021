...
# Over four years, there were 7136 #TidyTuesday tweets with attached media and alt-texts were attached to 2.4% of them.
]
...
(include a link to the descriptive summary table in the backup slides)
...
* Is your alt-text a repetition of the title or does it tell us something about the data as well?  
...
*	[Writing alt-text for data visualization |<br>Amy Cesal](https://medium.com/nightingale/writing-alt-text-for-data-visualization-2a218ef43f81)
* [Chartability Data Viz Audit Workbook |<br>Frank Elavsky](https://chartability.fizz.studio/)
...
---
name: backupSummaryStatistics

# Placeholder: HTML table with Liz's summary

(include link back to data viz with tweets and alt-text over time)
