...
- Growth in online learning communities for data science mediated by social networking apps 
like Twitter  

- [#TidyTuesday](https://www.tidytuesday.com), [GitHub](https://github.com/rfordatascience/tidytuesday)  
  ...
  - How accessible are TidyTuesday tweets for peopple who are blind or have low vision?  
...
- After removing duplicate tweets and tweets that didn't seem to contain data visualizations, there were 196 tweets with alt-text.  
...
- Online R books made available digitally to people with print disabilities via vy[Bookshare](https://www.bookshare.org/cms/)   
...
-	[Writing alt-text for data visualizat
ion](https://medium.com/nightingale/writing-alt-text-for-data-visualization-2a218ef43f81)
