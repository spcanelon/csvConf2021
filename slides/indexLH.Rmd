...
.left-col-narrow[
```{r out.width="60%", fig.alt='Square CSV Conf logo featuring a black comma against a yellow background'}
...
<!--HTML code inserting a circular avatar of a square photo-->
<img style="border-radius: 50%;" src="https://raw.githubusercontent.com/spcanelon/csvConf2021/master/slides/img/Profile_LH.JPG?token=AL4Z36OYWGDHOMZMJCKQKK3ATBRBM" width="170px" alt="Profile of Liz Hare"/>
...
* Make your data visualizations accessible everywhere you can<br>by adding alt-text to **websites, journalism, scientific publishing, social media**  
