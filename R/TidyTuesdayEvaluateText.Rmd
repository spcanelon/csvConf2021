...
I started with the file "data/AltTextSubset_Annotated.rds
...
I also removed rows where AltText == "ScrapingError". I ended up with 
...
annotatedRubric <- read.csv("../data/annotatedRubric1.csv")
